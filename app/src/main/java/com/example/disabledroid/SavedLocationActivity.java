...
public class SavedLocationActivity extends AppCompatActivity {
    ...
    private ListView saved_location_listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saved_location_listView = findViewById(R.id.saved_location_listView);
        list = new ArrayList<>();
        ...
        saved_location_listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                dlt_location.setOnClickListener(new View.OnClickListener() {
                    @Override
