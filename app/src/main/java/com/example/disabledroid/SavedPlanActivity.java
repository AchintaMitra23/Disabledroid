...
public class SavedPlanActivity extends AppCompatActivity {
    ...
    private ListView saved_plan_listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saved_plan_listView = findViewById(R.id.saved_plan_listView);
        list = new ArrayList<>();
        ...
        saved_plan_listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
    ...
    private void updatePlan(String str, int position) {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String update_plan = et_update.getEditText().getText().toString();
                if (update_plan.isEmpty()) {
                    ...
                    if (checkUpdation == true) {
                        ...
                        list.set(position, "DATE: " + strgs[1].toString() + " \nPLAN: " + newPlan);
                        arrayAdapter.notifyDataSetChanged();
                    } else {
